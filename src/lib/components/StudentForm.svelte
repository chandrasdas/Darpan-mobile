...
>
	...
	<div class="form-grid">
		...
		<div class="form-group">
			...
			<input type="date" name="dob" id="dob" required class="form-input" bind:value={dobValue} />
		</div>
	...
	<div class="form-grid">
		<div class="form-group">
			<label for="guardianNo" class="form-label"
				>Guardian Number <span class="required">*</span></label
			>
			<input
				type="number"
				name="guardianNo"
		...
		<div class="form-group">
			<label for="messageNo" class="form-label"
				>Message Number <span class="required">*</span></label
			>
			<input
				type="number"
				name="messageNo"
