                ...
                <div class="hero-filters">
                    <div class="filter-columns">
                        <div class="filter-group">
                            <select value={currentSession.toString()} onchange={(e) => { currentSession = Number((e.target as HTMLSelectElement).value); handleSectionChange(); }} class="form-select filter-select">
                            ...
                            <select value={currentEnrollId.toString()} onchange={(e) => { currentEnrollId = Number((e.target as HTMLSelectElement).value); handleStudentChange(); }} class="form-select filter-select">
        ...
        <div class="info-grid">
            ...
            <div class="info-item">
                ...
                <span class="info-value">
                    {data.classes.find(c => c.id === currentClass)?.name} - {sections.find(s => s.id === currentSection)?.letter}
                </span>
            </div>
        </div>
    </div>
            ...
            <table class="data-table">
                ...
                <tbody>
                    {#each uniqueSubjects as subject (subject.id)}
                        <tr>
                            <td class="font-medium text-left">{subject.name}</td>
                            {#each uniqueTerms as term (term.id)}
