	...
	<div class="profile-header-card" in:fly={{ y: 20, duration: 500, delay: 100 }}>
		<div class="profile-header-content">
			...
			<div class="profile-primary-info">
				...
				<p class="profile-fname">
					{student.fname} <span class="fname-label">(Father's Name)</span>
				</p>
				...
				<div class="enrollment-info">
					...
					{:else}
						<div class="enrollment-tag empty-enrollment">No current session enrollment</div>
					{/if}
				</div>
			</div>
